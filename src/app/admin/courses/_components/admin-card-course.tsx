...
import { Eye, MoreVerticalIcon, Pencil, School, TimerIcon, Trash2 } from "lucide-react";
  ...
  return (
    <Card className="relative py-0 gap-0 w-full group">
      ...
      <CardContent className="p-4">
        ...
        <CardDescription className="text-muted-foreground line-clamp-2 text-sm">{data.smallDescription}</CardDescription>
        ...
        <Link href={`/admin/courses/${data.id}/edit`} className={buttonVariants({className: 'w-full my-2'})}>Edit course</Link>
      </CardContent>
    </Card>
  );
};
